...
const WebsiteAccessibility = () => {
    ...
    return (
        <>
            ...
            <Button link="https://accessibility-tool.netlify.app/" ctaLink="portfolio-cta" wrapper_outer='portfolio-cta__outer-wrapper' wrapper_inner='portfolio-cta__inner-wrapper' wrapper_inner_inner="portfolio-cta__inner-inner" text='View Live Site' git_href="https://github.com/elliecrawley/Accessibility-tool" git_btn='git-cta'/>
            <ViewMore/>
        </>
    )
}
