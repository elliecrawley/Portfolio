...
const WineSpark = () => {
    ...
    return (
        <>
            ...
            <Button link="https://winespark.com" ctaLink="portfolio-link" wrapper_outer='portfolio-cta__outer-wrapper' wrapper_inner='portfolio-cta__inner-wrapper' wrapper_inner_inner="portfolio-cta__inner-inner" btn_class='portfolio-cta' text='View Live Site'/>
            <ViewMore/>
        </>
    )
}
