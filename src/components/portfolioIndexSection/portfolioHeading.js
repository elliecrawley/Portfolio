    ...
    return (
        <div className="portfolio-wrapper">
            ...
            <div className="portfolio-item-wrapper">
                <Link to="/Emily-Carter" className="portfolio-item">
                ...
                <Link to="/WineSpark" className="portfolio-item">
                ...
                <Link to="/Cultured-Biomecare" className="portfolio-item">
                ...
                <Link to="/Avery-Row" className="portfolio-item">
                ...
                <Link to="/Accessiblity-tool" className="portfolio-item">
                ...
                <Link to="/Smaller-Projects" className="portfolio-item">
