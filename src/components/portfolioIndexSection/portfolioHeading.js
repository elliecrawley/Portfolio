...
return (
    <div className="portfolio-wrapper">
        ...
        <p className='temp-text'>This website is currently undergoing an update. Please check back soon for examples of my work, or get in touch using the contact form below.</p>
    </div>
)
    // return (
    //     <div className="portfolio-wrapper">
